      ...
      <div class="modal-body">
			...
			<button id='btn-upload' class="btn btn-info" onfocus="this.blur();">이미지찾기</button>
				...
				<div class="control-group">											
					...
					<div class="controls">
						<input type="text" name="memEmail" id="memEmail" class="span3 m-wrap">
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
			...
			<div class="form-actions">				 	
				<button class="btn btn-primary" id="new">잠재고객 등록</button>
				<button class="btn btn-default" id="prod">등록후 상품 판매</button>
