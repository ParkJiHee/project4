							...
							<div class="tab-content">
								...
								<form id="edit-profile" class="form-horizontal" 
									...
									<fieldset>
										...
										<div class="control-group">											
											<label class="control-label">상품 번호</label>
											<div class="controls">
												<input type="text" readonly="readonly" class="span6" name="productNo" value="${ product.productNo }">
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span6" name="productName" value="${ product.productName }">
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												...
												<textarea rows="5" class="span6" name="productExplain">${ product.productExplain }</textarea>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
                                        ...
                                        <div class="control-group">											
                                            ...
                                            <div class="controls">
                                               <div class="input-prepend input-append">
                                                  <input class="span2" name="productPrice" type="text" value="${ product.productPrice }">
